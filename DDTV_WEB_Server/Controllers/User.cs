...
namespace DDTV_WEB_Server.Controllers
{
    ...
    public class User_Search : ProcessingControllerBase.ApiControllerBase
    {
        ...
        {
            return Content(MessageBase.Success(nameof(User_Search),DDTV_Core.SystemAssembly.BilibiliModule.API.Search.Search.Search_Live_User(keyword)), "application/json");
        }
    }
